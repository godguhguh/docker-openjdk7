...
# -----------------------------------------------------------------------------
JAVA_OPTS="-server -XX:PermSize=256m -XX:MaxPermSize=512m -Xms2048m -Xmx2048m -verbose:gc -XX:+UseConcMarkSweepGC -XX:MaxTenuringThreshold=5 -XX:+ExplicitGCInvokesConcurrent -XX:GCTimeRatio=19 -XX:CMSInitiatingOccupancyFraction=70 -XX:CMSFullGCsBeforeCompaction=0 -Xnoclassgc -XX:SoftRefLRUPolicyMSPerMB=0 -Djava.awt.headless=true -Duser.timezone=GMT+08"
